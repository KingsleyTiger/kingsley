...
VoIP를 인터셉트하기 위해 공격자는 RTP스트림을 먼저 인터셉트해야 한다. RTP 스트림은 무엇일까? RTP란 Real Time Protocol로 사용자가 생성한 연속적인 소리 페이로드를 네트워크를 통해 상대방에게 전달한다. 일단 공격자는 전화를 건사람과 전화를 받는 사람 사이에서 ARP spoofing을 사용한다. 
